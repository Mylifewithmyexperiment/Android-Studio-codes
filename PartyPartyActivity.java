...
public class PartyPartyActivity extends Activity {
...
//        Code for Delete button
        ...
        btn4.setOnClickListener(new OnClickListener()
        {
			...
			public void onClick(View v) 
			{
				final Dialog dialog = new Dialog(PartyPartyActivity.this);
...
//        View one or Search
		  ...
		  btnUpdate.setOnClickListener(new OnClickListener() 
		  {
			public void onClick(View v) 
			{
				...
				str8= et8.getText().toString();
				db.open();
				long id = db.UpdateContact(str1, str2, str3, str4, str5, str6, str7, str8);
				db.close();	
			}
		});
    }
